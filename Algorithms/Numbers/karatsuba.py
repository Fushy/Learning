...
import math
# chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/https://www.lri.fr/~hivert/COURS/Methodo/TPKara.pdf
...
def karatsuba(x, y):
    ...
    q0 = karatsuba(a, c)
    q1 = karatsuba(b, d)
    q2 = karatsuba(a + b, c + d)
    res = (q0 * 10 ** (mid * 2)) + ((q2 - q0 - q1) * 10 ** mid) + q1
    return res


# Example: 1357 x 2468 = 3349076
# print('1357 * 2468 =', karatsuba(1357, 2468))
# print(karatsuba(12, 25))
